...
export function SingleRaycast() {
	...
	const updateCanvases = useCallback(() => {
		...
		wasm.dda_single(mapCtx, scaleRef.current);
		wasm.render_dda_single(renderCtx, scaleRef.current, renderCanvas.width, renderCanvas.height);
	}, [wasm]);
